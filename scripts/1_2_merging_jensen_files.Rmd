---
title: "1_2_merging_jensen_files"
author: "Aidan Coyle"
date: "12/06/2021"
...
db_path <- "../data/jensen_data/Hemato_samples/databases_thru_2013/FRP_Database_ReadOnly.accdb"
...
write.table(full.dat, file = "../output/jensen_cleaned_data/accessdb_all_cols.txt",
            row.names = FALSE,
            sep = "\t")
```
...
excel.files <- Sys.glob(c("../data/jensen_data/Hemato_samples/data_2014-2019/*/201?_BCS_Index_Station_Collection_Data_MASTE*.xlsx"))
...
write.table(recent.dat, file = "../output/jensen_cleaned_data/excel_ebs_data_all_cols.txt", 
            row.names = FALSE,
            sep = "\t")
...
excel_path <- "../data/jensen_data/Hemato_samples/data_2014-2019/2015_StMatt/"
...
# Some info comes from protocol in ../data/jensen_data/Hemato_samples/data_2014-2019/2015_StMatt/2015_ADFG_St._Matthew_BCS_Protocol_Dmitri
SMI.dat$Year <- 2015
...
write.table(SMI.dat, file = "../output/jensen_cleaned_data/2015_SMI_data_all_cols.txt", 
          row.names = FALSE,
          sep = "\t")
...
write.table(full.dat, file = "../output/jensen_cleaned_data/all_data_all_cols.txt", 
          row.names = FALSE,
          sep = "\t")
```
### Cleaning
...
write.table(full.plate.dat, file = "../output/jensen_cleaned_data/relevant_sample_data.txt", 
            row.names = FALSE,
            sep = "\t")
